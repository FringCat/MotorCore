...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI1_NSS_Pin|TEST1_Pin|TEST2_Pin|MT6835_CS_Pin
                          |ENABLE_Pin|PWML_Pin|STB_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI1_NSS_Pin TEST1_Pin TEST2_Pin MT6835_CS_Pin
                           ENABLE_Pin PWML_Pin */
  GPIO_InitStruct.Pin = SPI1_NSS_Pin|TEST1_Pin|TEST2_Pin|MT6835_CS_Pin
                          |ENABLE_Pin|PWML_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
