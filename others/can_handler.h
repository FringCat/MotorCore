...
#define LPF_U_Alpha 0.611
#define LPF_U_Beta  0.389
//#define CAN_FDCAN
...
// typedef void (*Get_Control_Cmd)(CAN_Handler_t *can_handler_ptr,uint8_t *cmd_data);
// typedef void (*Reply_Data)(CAN_Handler_t *can_handler_ptr,float p, float v, float t, float uq, float ud);
// typedef void (*Can_Reset_Cmd)(CAN_Handler_t *can_handler_ptr);
// typedef void (*Can_printf_cmd)(CAN_Handler_t *can_handler_ptr);
...
struct CAN_Handler
{
    ...
    // Can_printf_cmd pfct_can_printf_cmd;
};
