...
#if MT6835_USE_DEBUG == 0
#include "stdio.h"
#include "SEGGER_RTT.h"
#define MT6835_DEBUG(...)       SEGGER_RTT_printf(0, __VA_ARGS__)
#else
#define MT6835_DEBUG(...)
#endif
...
typedef enum mt6835_cmd_enum_t {
    MT6835_CMD_RD = (0x03),                 /**< user read register. (0b0011) */
    MT6835_CMD_WR = (0x06),                 /**< user write register. (0b0110) */
    MT6835_CMD_EEPROM = (0x0C),             /**< user erase and program EEPROM. (0b1100) */
    MT6835_CMD_ZERO = (0x05),               /**< AUTO setting zero. (0b0101) */
    MT6835_CMD_BURST = (0x0A),              /**< burst mode. (0b1010) */
} mt6835_cmd_enum_t;
...
/* Declare the global mt6835 pointer here as extern to avoid multiple
 * definitions when this header is included from multiple C files.
 * Define the actual storage in one C file, for example in main.c:
