...
typedef struct
{
    ...
    uint32_t Calibrate_Ioffset_nonblock__sample_total;
    uint32_t Calibrate_Ioffset_nonblock__IA_offset_raw_all;
    uint32_t Calibrate_Ioffset_nonblock__IB_offset_raw_all;
    uint32_t Calibrate_Ioffset_nonblock__IC_offset_raw_all;
